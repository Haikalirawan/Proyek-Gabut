                ...
                <div class="card-body">
					<a href="<?= base_url('Total_siswa') ?>" style="text-decoration: none">
						<div class="row no-gutters align-items-center">
							<div class="col mr-2">
							<div class="text-xs font-weight-bold text-light text-uppercase mb-1">Total</div>
...
<div class="col-xl-12 col-lg-12 mt-5">
	<div class="card shadow mb-4">
		...
		<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
			<h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-user text-primary-300"></i>&nbsp;&nbsp;Total siswa</h6>
		...
		<div class="card-body">
			<div class="ml-4 text-left small">
				<span class="mr-2">
					<i class="fas fa-circle text-success"></i>&nbsp; Total siswa : 250 Data
				</span>
			</div>
