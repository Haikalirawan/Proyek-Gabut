            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-warning shadow h-100 py-2 bg-warning">
                <div class="card-body">
                  ...
                  <div class="row no-gutters align-items-center">
											<div class="col mr-2">
												<div class="text-xs font-weight-bold text-uppercase mb-1 text-light">Pengembalian</div>
												<div class="h5 mb-0 font-weight-bold text-gray-800">Buku</div>
											</div>
											<div class="col-auto">
...
<div class="col-xl-12 col-lg-12 mt-5">
	<div class="card shadow mb-4">
		...
		<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
			<h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-user text-primary-300"></i>&nbsp;&nbsp;Total pengembalian</h6>
		...
		<div class="card-body">
			<div class="ml-4 text-left small">
				<span class="mr-2">
					<i class="fas fa-circle text-success"></i>&nbsp; Total pengembalian : 250 Data
				</span>
			</div>
		...
		<div class="text-right mt-3 mr-4 mb-2">
            ...
            <input type="text" class="form-control bg-light border-0 small" placeholder="Cari pengembalian..." aria-label="Search" aria-describedby="basic-addon2">
