...
<div class="col-xl-12 col-lg-12 mt-5">
	<div class="card shadow mb-4">
		...
		<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
			<h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-user text-primary-300"></i>&nbsp;&nbsp;Total buku</h6>
		...
		<div class="card-body">
			<div class="ml-4 text-left small">
				<span class="mr-2">
					<i class="fas fa-circle text-success"></i>&nbsp; Total buku : 250 Data
				</span>
			</div>
